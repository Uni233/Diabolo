...
#if 0
		void Triangulate(const bool flag,std::vector< VR_FEM::MC_Vertex >&  vecMCVertex,const int nLastVertexIdx, int &nCurrentVertexSize, std::vector< VR_FEM::MC_Edge >& vecMCEdge,int& nCurrentEdgeSize, std::vector< VR_FEM::MC_Surface >& vecMCSurface, int& nCurrentFaceSize);
#endif
