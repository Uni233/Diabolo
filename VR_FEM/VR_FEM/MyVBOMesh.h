...
public:
	...
	virtual void loadDisplacementOBJ( YC::Geometry::MeshDataStruct& obj);
	...
	virtual void updateVBO( const vector<vec3> & points,	const vector<vec3> & normals,	const vector<vec2> &texCoords,	const vector<vec4> &tangents,	const vector<int> &elements );
