...
void MyVBOMesh::loadDisplacementOBJ( YC::Geometry::MeshDataStruct& obj)
{
	//m_objInfo = obj;

	vector <vec3>& points = obj.displacedVertices;
	vector <vec3>& normals = obj.normals;
	vector <vec2>& texCoords = obj.texCoords;
	vector <int>& faces = obj.faces;
...
void MyVBOMesh::updateVBO( const vector<vec3> & points,	
